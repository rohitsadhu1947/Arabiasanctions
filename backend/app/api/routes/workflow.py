...
# Initialize with comprehensive demo cases
def init_demo_cases():
    ...
    demo_cases = [
        ...
        {
            "id": 1,
            "case_number": "WF-20241216-A001",
            "screening_result_id": 1,
            "screening_match_id": 1,
            "reference_id": "SCR-20241216-UAE001",
            "status": CaseStatus.OPEN,
            "priority": CasePriority.HIGH,
            "assigned_to_id": 2,
            ...
            "country_code": "UAE",
            "branch_code": "DXB001",
            "screened_name": "Mohammad Al-Rashid",
            "highest_match_score": 0.92,
        },
        {
            "id": 2,
            "case_number": "WF-20241216-A002",
            "screening_result_id": 2,
            "screening_match_id": 2,
            "reference_id": "SCR-20241216-UAE002",
        ...
        {
            "id": 3,
            "case_number": "WF-20241216-A003",
            "screening_result_id": 3,
            "screening_match_id": 3,
            "reference_id": "SCR-20241216-UAE003",
            ...
            "due_date": (datetime.utcnow() + timedelta(hours=22)).isoformat(),
            "sla_deadline": (datetime.utcnow() + timedelta(hours=22)).isoformat(),
            "sla_breached": False,
            "tat_hours": 2.0,
            "resolution": None,
            "resolution_notes": None,
            ...
            "country_code": "UAE",
            "branch_code": "AUH001",
            "screened_name": "Gulf Trading LLC",
            "highest_match_score": 0.78,
        },
        {
            "id": 4,
            "case_number": "WF-20241215-A004",
            "screening_result_id": 4,
            "screening_match_id": 4,
            "reference_id": "SCR-20241215-UAE004",
            ...
            "tat_hours": 6.5,
            "resolution": "released",
            "resolution_notes": "False positive - different date of birth confirmed",
            "resolved_by_name": "Sarah Johnson",
            "resolved_at": (datetime.utcnow() - timedelta(hours=21)).isoformat(),
            "return_count": 0,
            "max_returns": 3,
            "country_code": "UAE",
            "branch_code": "DXB002",
            "screened_name": "Khalid Al-Mahmoud",
            "highest_match_score": 0.65,
        },
        # === Qatar Cases ===
        {
            "id": 5,
            "case_number": "WF-20241216-Q001",
            "screening_result_id": 5,
            "screening_match_id": 5,
            "reference_id": "SCR-20241216-QAT001",
            "status": CaseStatus.OPEN,
            "priority": CasePriority.HIGH,
            "assigned_to_id": 5,
            "assigned_to_name": "Ahmed Al-Thani",
            "assigned_by_id": 1,
            "assigned_by_name": "Admin User",
            "escalation_level": 0,
            "escalated_from_name": None,
            ...
            "due_date": (datetime.utcnow() + timedelta(hours=23)).isoformat(),
            "sla_deadline": (datetime.utcnow() + timedelta(hours=23)).isoformat(),
            "sla_breached": False,
            "tat_hours": 1.0,
            "resolution": None,
            "resolution_notes": None,
            ...
            "country_code": "QAT",
            "branch_code": "DOH001",
            "screened_name": "Viktor Petrov Ivanov",
            "highest_match_score": 0.89,
        },
        {
            "id": 6,
            "case_number": "WF-20241216-Q002",
            "screening_result_id": 6,
            "screening_match_id": 6,
            "reference_id": "SCR-20241216-QAT002",
            "status": CaseStatus.PENDING_APPROVAL,
            "priority": CasePriority.MEDIUM,
            "assigned_to_id": 3,
            "assigned_to_name": "Michael Chen",
            "assigned_by_id": 5,
            "assigned_by_name": "Ahmed Al-Thani",
            "escalation_level": 0,
            "escalated_from_name": None,
            "escalation_reason": None,
            "created_at": (datetime.utcnow() - timedelta(hours=6)).isoformat(),
            "due_date": (datetime.utcnow() + timedelta(hours=18)).isoformat(),
            "sla_deadline": (datetime.utcnow() + timedelta(hours=18)).isoformat(),
            "sla_breached": False,
            "tat_hours": 6.0,
            "resolution": None,
            "resolution_notes": None,
            ...
            "country_code": "QAT",
            "branch_code": "DOH001",
            "screened_name": "Horizon Investments WLL",
            "highest_match_score": 0.72,
        },
        # === Saudi Arabia Cases ===
        {
            "id": 7,
            "case_number": "WF-20241216-S001",
            "screening_result_id": 7,
            "screening_match_id": 7,
            "reference_id": "SCR-20241216-SAU001",
            "status": CaseStatus.ESCALATED,
            "priority": CasePriority.URGENT,
            "assigned_to_id": 6,
            "assigned_to_name": "Fatima Al-Saud",
            "assigned_by_id": 1,
            "assigned_by_name": "Admin User",
            "escalation_level": 2,
            "escalated_from_name": "Local Officer",
            "escalation_reason": "PEP status confirmed - requires head office approval",
            ...
            "country_code": "SAU",
            "branch_code": "RUH001",
            "screened_name": "HRH Prince Abdullah bin Fahd",
            "highest_match_score": 0.98,
        },
        {
            "id": 8,
            "case_number": "WF-20241215-S002",
            "screening_result_id": 8,
            "screening_match_id": 8,
            "reference_id": "SCR-20241215-SAU002",
            "status": CaseStatus.CLOSED,
            "priority": CasePriority.HIGH,
            "assigned_to_id": 2,
            "assigned_to_name": "Sarah Johnson",
            ...
            "tat_hours": 8.2,
            "resolution": "flagged",
            "resolution_notes": "Confirmed match - flagged for enhanced monitoring",
            "resolved_by_name": "Sarah Johnson",
            "resolved_at": (datetime.utcnow() - timedelta(hours=28)).isoformat(),
            "return_count": 0,
            "max_returns": 3,
            "country_code": "SAU",
            "branch_code": "JED001",
            "screened_name": "Faisal Al-Ahmadi",
            "highest_match_score": 0.91,
        },
        # === Kuwait Cases ===
        {
            "id": 9,
            "case_number": "WF-20241216-K001",
            "screening_result_id": 9,
            "screening_match_id": 9,
            "reference_id": "SCR-20241216-KWT001",
            "status": CaseStatus.IN_PROGRESS,
            "priority": CasePriority.MEDIUM,
            "assigned_to_id": 4,
            "assigned_to_name": "Emma Williams",
            ...
            "due_date": (datetime.utcnow() + timedelta(hours=21)).isoformat(),
            "sla_deadline": (datetime.utcnow() + timedelta(hours=21)).isoformat(),
            "sla_breached": False,
            "tat_hours": 3.0,
            "resolution": None,
            "resolution_notes": None,
            ...
            "country_code": "KWT",
            "branch_code": "KWC001",
            "screened_name": "Kremlin Energy Holdings",
            "highest_match_score": 0.84,
        },
        {
            "id": 10,
            "case_number": "WF-20241215-K002",
            "screening_result_id": 10,
            "screening_match_id": 10,
            "reference_id": "SCR-20241215-KWT002",
            "status": CaseStatus.CLOSED,
            "priority": CasePriority.LOW,
            "assigned_to_id": 3,
            "assigned_to_name": "Michael Chen",
            ...
            "tat_hours": 4.5,
            "resolution": "released",
            "resolution_notes": "No match - different individual confirmed by ID verification",
            "resolved_by_name": "Michael Chen",
            "resolved_at": (datetime.utcnow() - timedelta(hours=43)).isoformat(),
            "return_count": 0,
            "max_returns": 3,
            "country_code": "KWT",
            "branch_code": "KWC001",
            "screened_name": "Omar Abdul Rahman (Customer)",
            "highest_match_score": 0.68,
        },
        # === Bahrain Cases ===
        {
            "id": 11,
            "case_number": "WF-20241216-B001",
            "screening_result_id": 11,
            "screening_match_id": 11,
            "reference_id": "SCR-20241216-BHR001",
            "status": CaseStatus.OPEN,
            "priority": CasePriority.HIGH,
            "assigned_to_id": 2,
            "assigned_to_name": "Sarah Johnson",
            ...
            "country_code": "BHR",
            "branch_code": "MAN001",
            "screened_name": "Global Trade Holdings Ltd",
            "highest_match_score": 0.88,
        },
        # === Oman Cases ===
        {
            "id": 12,
            "case_number": "WF-20241216-O001",
            "screening_result_id": 12,
            "screening_match_id": 12,
            "reference_id": "SCR-20241216-OMN001",
            "status": CaseStatus.PENDING_APPROVAL,
            "priority": CasePriority.MEDIUM,
            "assigned_to_id": 4,
            "assigned_to_name": "Emma Williams",
            ...
            "due_date": (datetime.utcnow() + timedelta(hours=16)).isoformat(),
            "sla_deadline": (datetime.utcnow() + timedelta(hours=16)).isoformat(),
            "sla_breached": False,
            "tat_hours": 8.0,
            "resolution": None,
            "resolution_notes": None,
            ...
            "country_code": "OMN",
            "branch_code": "MCT001",
            "screened_name": "Ali Mahmoud Saleh",
            "highest_match_score": 0.76,
        },
        # === SLA Breached Cases ===
        {
            "id": 13,
            "case_number": "WF-20241214-A013",
            "screening_result_id": 13,
            "screening_match_id": 13,
            "reference_id": "SCR-20241214-UAE013",
            "status": CaseStatus.OPEN,
            "priority": CasePriority.URGENT,
            "assigned_to_id": 2,
            "assigned_to_name": "Sarah Johnson",
            ...
            "escalation_reason": "SLA deadline exceeded - auto-escalated",
            ...
            "country_code": "UAE",
            "branch_code": "DXB001",
            "screened_name": "Petrochemical Industries Corp",
            "highest_match_score": 0.94,
        },
        {
            "id": 14,
            "case_number": "WF-20241213-S014",
            "screening_result_id": 14,
            "screening_match_id": 14,
            "reference_id": "SCR-20241213-SAU014",
            "status": CaseStatus.IN_PROGRESS,
            "priority": CasePriority.HIGH,
            "assigned_to_id": 6,
            "assigned_to_name": "Fatima Al-Saud",
            ...
            "sla_deadline": (datetime.utcnow() - timedelta(hours=6)).isoformat(),
            "sla_breached": True,
            "tat_hours": 30.0,
            "resolution": None,
            "resolution_notes": None,
            ...
            "country_code": "SAU",
            "branch_code": "RUH001",
            "screened_name": "Tehran Trading Company LLC",
            "highest_match_score": 0.87,
        },
        # === Additional Recent Cases ===
        {
            "id": 15,
            "case_number": "WF-20241216-Q003",
            "screening_result_id": 15,
            "screening_match_id": 15,
            "reference_id": "SCR-20241216-QAT003",
            "status": CaseStatus.OPEN,
            "priority": CasePriority.LOW,
            "assigned_to_id": 5,
            "assigned_to_name": "Ahmed Al-Thani",
            ...
            "country_code": "QAT",
            "branch_code": "DOH001",
            "screened_name": "Fatima Al-Hassan",
            "highest_match_score": 0.62,
        },
    ]
    ...
    for case in demo_cases:
        ...
        CASE_ACTIONS[case["id"]] = [{
            ...
            "performed_by_name": "System",
            "performed_at": case["created_at"],
            "comment": f"Case created - Match score: {case['highest_match_score']*100:.0f}%",
            "previous_status": None,
            "new_status": CaseStatus.OPEN,
        }]
